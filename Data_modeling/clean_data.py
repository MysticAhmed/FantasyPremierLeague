...
def clean_data(future_fixtures_df, match_df):
    ...
    numeric_columns = ['goals_scored', 'assists', 'minutes', 'yellow_cards', 'penalties_saved', 'saves', 'clean_sheets', 'own_goals', 'bps', 'form', 'points_per_game', 'ict_index']
    ...
    return future_fixtures_df, match_df, goalie_df, defender_df, midfielder_df, forward_df